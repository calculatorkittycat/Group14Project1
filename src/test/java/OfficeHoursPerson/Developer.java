...
public class Developer extends Employee{
    ...
    public Developer(String name, char gender, LocalDate dOb, String jobTitle, int employeeID, double salary) {
    ...
    public void drink(String drink) {
        System.out.println(getJobTitle() + getName() + " is in drinking " + drink);
    }
}
